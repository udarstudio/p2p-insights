<script setup>
useSeoMeta({
  title: 'Robo.cash Review (2026) | P2P Insights',
  description:
    'A practical 2026 Robo.cash review: automated portfolios, 8–11% listed rates, deposits and withdrawals, liquidity, reliability, and the risks to understand.'
})

const breadcrumbs = [
  { label: 'Home', to: '/' },
  { label: 'Platforms', to: '/platforms' },
  { label: 'Robo.cash', to: '/platforms/robocash' }
]
</script>
...
<template>
  <main class="mx-auto max-w-5xl px-6 py-12">
    ...
    <article class="space-y-10" aria-labelledby="robocash-review-title">
      <header class="space-y-3">
        <h1
          id="robocash-review-title"
      ...
      <section class="space-y-3">
        ...
        <ol class="list-decimal space-y-2 pl-6 text-base leading-relaxed text-slate-700 dark:text-slate-300 sm:text-lg">
          <li>Register, verify your identity, and fund the account with a EUR bank transfer.</li>
          <li>Create either a One-click portfolio or a custom portfolio.</li>
          <li>Choose the parameters you want for a custom portfolio, such as loan originators, terms, and rates.</li>
          <li>Let the portfolio allocate cash and reinvest according to your selected income settings.</li>
        </ol>
        <p class="text-base leading-relaxed text-slate-700 dark:text-slate-300 sm:text-lg">
      ...
      <section class="space-y-3">
        ...
        <ul class="list-disc space-y-2 pl-6 text-base leading-relaxed text-slate-700 dark:text-slate-300 sm:text-lg">
          <li>Deposits are made by personal EUR bank transfer, not by card.</li>
          <li>Available, uninvested cash can be moved to the Wallet immediately.</li>
          <li>Wallet withdrawals have a usual minimum of EUR 50.</li>
          <li>Invested loans need to be sold on the Secondary Market before they can become withdrawable cash.</li>
          <li>Robo.cash says a secondary-market sale usually takes around 1–7 days, so it is not guaranteed instant liquidity.</li>
        </ul>
      ...
      <section class="space-y-3">
        ...
        <ul class="list-disc space-y-2 pl-6 text-base leading-relaxed text-slate-700 dark:text-slate-300 sm:text-lg">
          <li>Investors who want a straightforward, hands-off P2P allocation.</li>
          <li>People happy to choose broad portfolio rules instead of individual loans.</li>
          <li>Investors who can leave money invested and do not need immediate access to it.</li>
          <li>Those who value the platform’s repayment history but still diversify across providers and asset types.</li>
        </ul>
      </section>
      ...
      <section class="space-y-3">
        ...
        <ul class="list-disc space-y-2 pl-6 text-base leading-relaxed text-slate-700 dark:text-slate-300 sm:text-lg">
          <li>Anyone who needs instant deposits, withdrawals, or emergency-fund liquidity.</li>
          <li>Investors who want to select each loan or lending company manually.</li>
          <li>Those looking for a regulated investment service or formal investor compensation cover.</li>
          <li>Anyone uncomfortable with the credit and group-risk concentration behind the platform.</li>
        </ul>
      </section>
        ...
        <div class="grid gap-4 sm:grid-cols-2">
          <div class="rounded-xl border border-emerald-300 bg-emerald-50 p-4 dark:border-emerald-500/40 dark:bg-emerald-500/10">
            ...
            <ul class="mt-2 list-disc space-y-1 pl-6 text-sm text-emerald-900 dark:text-emerald-100">
              <li>Easy, genuinely hands-off portfolio management.</li>
              <li>No manual loan selection required.</li>
              <li>Listed annual rates of 8–11%.</li>
              <li>No Robo.cash investor fees for core platform actions.</li>
              <li>Strong historical repayment record since 2017.</li>
              <li>30-day buyback and stated UnaFinancial support structure.</li>
              <li>Secondary Market available for early exits.</li>
            </ul>
          </div>
          <div class="rounded-xl border border-rose-300 bg-rose-50 p-4 dark:border-rose-500/40 dark:bg-rose-500/10">
            ...
            <ul class="mt-2 list-disc space-y-1 pl-6 text-sm text-rose-900 dark:text-rose-100">
              <li>Deposits and Wallet withdrawals normally take 2–3 business days.</li>
              <li>No manual investing or individual primary-market loan selection.</li>
              <li>All originators belong to the same group, creating concentration risk.</li>
            </ul>
          </div>
        </div>
      </section>
